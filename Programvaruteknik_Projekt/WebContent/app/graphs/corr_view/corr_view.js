System.register(["angular2/core", "../services/calculate"], function(exports_1, context_1) {
    "use strict";
    ...
    return {
        ...
        execute: function() {
            ...
            CorrView = (function () {
                function CorrView(_calculateService) {
                    this._calculateService = _calculateService;
                }
                CorrView.prototype.update = function (data) {
                    var info = this._calculateService.calculate(Object.keys(data.data).map(function (k) { return [data.data[k].a, data.data[k].b]; }));
                    this.charts =
                        [{
                                id: "chart-" + this.id,
                                data: {
                ...
                CorrView = __decorate([
                    core_1.Component({
                        ...
                        providers: [calculate_1.CalculateService],
                        templateUrl: "corr_view.html"
                    }), 
                    __metadata('design:paramtypes', [calculate_1.CalculateService])
                ], CorrView);
                return CorrView;
            }());
