...
public class USCrimeRateData extends JSONDataSourceBuilder {
	@SuppressWarnings("unchecked")
	public USCrimeRateData() {
		setSourceSupplier(DataSupplierFactory
				.createURLFetcher("https://www.quandl.com/api/v3/datasets/FBI_UCR/USCRIME_TYPE_VIOLENTCRIMERATE.json"));
	...
	public static void main(String[] args) {
		DataSource source = new USCrimeRateData().build();
