...
public class USAlcoholConsumptionData extends JSONDataSourceBuilder
{
	@SuppressWarnings("unchecked")
	public USAlcoholConsumptionData() 
	{
		setSourceSupplier(
				DataSupplierFactory.createURLFetcher("https://www.quandl.com/api/v3/datasets/NIAAA/DRINKERS.json"));
		    ...
		    {
			DataSource source = new USAlcoholConsumptionData().build();
