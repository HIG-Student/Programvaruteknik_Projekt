...
public class GasAndDieselOilProductionData extends JSONDataSourceBuilder
{
	@SuppressWarnings("unchecked")
	public GasAndDieselOilProductionData() 
	{
		setSourceSupplier(
				DataSupplierFactory.createURLFetcher("https://www.quandl.com/api/v3/datasets/UN/GASDIESELOILSTOTALPRODUCTION_SWE.json"));
		    ...
		    {
			DataSource source = new GasAndDieselOilProductionData().build();
